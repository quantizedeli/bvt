...
REPLICATIONS = [
    ...
    },
    {
        ...
        "metric": "HLI pozitif ülke sayısı",
        "orijinal_deger": 3.0,
        "orijinal_str": ">=3/5 ülkede anlamlı artış",
        "tolerans_pct": 0,
        ...
        "bvt_func": "run",
        "bvt_key": "n_positive_countries",
        "kaynak": "Front. Psych. 2021",
        "aciklama": "5 ülke eş zamanlı HLI: Δr>0 olan ülke sayısı (yön testi)",
    },
    # ── FAZ E (v9.3) ────────────────────────────────────────────────────
    {
        "makale": "McCraty 1998",
