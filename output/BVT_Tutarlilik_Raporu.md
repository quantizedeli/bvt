...
| Sabitler | KAPPA_EFF | 5.0 | 5.0 | ±0.5 | ✅ PASS |
| Sabitler | G_EFF | 5.06 | 5.06 | ±0.1 | ✅ PASS |
| Sabitler | N_C_SUPERRADIANCE | 10 | 10 | ±0.5 | ✅ PASS |
| Sabitler | MU_HEART | 1e-05 | 1e-05 | ±1e-07 | ✅ PASS |
...
| Level 1 — EM 3D | mu_heart_order | -5.0 | -5.0 | ±0.01 | ✅ PASS |
...
| Level 4 — N Kişi | N_c | 10 | 10 | ±0.5 | ✅ PASS |
...
| Level 9 — Kalibrasyon | KAPPA_EFF_check | 5.0 | 5.0 | ±0.5 | ✅ PASS |
...
| Level 17 — Ses Frekansları | gamma_bonus_check | 0.04 | 0.04 | ±0.015 | ✅ PASS |
...
| `bvt_studio/bvt_dashboard.py` | ⚠️ MISSING |
| `bvt_studio/nb01_halka_topoloji.py` | ⚠️ MISSING |
| `bvt_studio/nb04_uclu_rezonans.py` | ⚠️ MISSING |
| `bvt_studio/nb09_literatur_explorer.py` | ⚠️ MISSING |
...
| Test | Gerçek | Beklenen | Durum |
|---|---|---|---|
| ses_bonus 7.8Hz | 0.2367 | >=0.14 | ✅ |
| ses_bonus 6.7Hz | 0.1006 | >=0.00 | ✅ |
| ses_bonus 40.0Hz | 0.0336 | >=0.03 | ✅ |
| ses_bonus 440.0Hz | 0.0635 | >=0.00 | ✅ |
